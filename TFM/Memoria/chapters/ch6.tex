...
\figuraMemoria{fig_validation_report_html.png}{Informe de validación HTML renderizado en el navegador desde la consola web: resumen de conformidad por indicador y detalle del resultado. Elaboración propia.}{fig:informe-html-renderizado}
