...
- Configuración declarativa: `scripts/planning/github_project_planificacion.json`
...
La API de planificación crea datos y campos. Luego, en la UI del Project:
