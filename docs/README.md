...
- `guia_centralizada.md`: punto unico recomendado para ejecutar y entender el flujo.
...
- `ingesta_tecnica_postgres.md`: detalle de ingesta tecnica PostgreSQL.
...
- `tfm_oficial_objetivos_decisiones.md`: enunciado oficial + alineacion con alcance real + decisiones tecnicas (riesgos/mitigacion).
